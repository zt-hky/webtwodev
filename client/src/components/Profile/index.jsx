            ...
            <section className="Content_Form_Profile">
                ...
                <form onSubmit={this.frmRegister_onSubmit}>
                    <section className="Content_Form_Profile_Info">
                        ...
                        <input style={{ border: this.state.emailError ? '2px solid red' : '' }} name="email" id="disabledInput" onChange={this.txtEmail_onChange} value={this.state.email} type="email" placeholder="Email@gmail.com" disabled />
