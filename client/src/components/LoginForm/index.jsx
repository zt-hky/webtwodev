...
class LoginForm extends React.Component {
    ...
    frmLogin_onSubmit = (event) => {
        this.props.onWaitting({isWatting: true})
        ...
        return (
            <section className="Content_Form">
                ...
                <form onSubmit={this.frmLogin_onSubmit}>
                    ...
                    <button type="submit">{this.props.isWatting? <CircularProgress color="secondary">Đăng nhập</CircularProgress>: "Đăng nhập"} </button>
                </form>
                {this.state.goTo}
            </section>
        );
...
function mapDispatchToProp(dispatch) {
    return bindActionCreators({
        ...
        onWaitting: ActionCreator.SignInActions.onWaitting,
        ...
        return (
            <div>
                <Dialog open={this.state.open} onClose={this.btnCancel_onClick} aria-labelledby="form-dialog-title">
                    ...
                    <DialogActions>
                        {this.props.isWatting? <CircularProgress></CircularProgress>:""}
                        {this.props.success ?
                            ...
                            <div><Button onClick={this.btnCancel_onClick} color="primary">Huỷ</Button>
                                <Button onClick={this.btnSend_onClick} color="primary">Gửi</Button></div>}
                    </DialogActions>
                </Dialog>
            </div>
        );
