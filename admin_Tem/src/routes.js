...
const Theaters_Detail = React.lazy(() => import('./views/Theaters/Theaters_Detail'));

const Combo_Form=  React.lazy(() => import('./views/Combo/Combo_Form'));
const Combo_List=  React.lazy(() => import('./views/Combo/Combo_List'));
const Theater_Form = React.lazy(() => import('./views/Theaters/Theater_Form'));
const Theaters_Form = React.lazy(() => import('./views/Theaters/Theaters_Form'));

const Film_Type = React.lazy(() => import('./views/Film/Film_Type'));
const Films = React.lazy(() => import('./views/Film/Films'));
const Film_Form = React.lazy(() => import('./views/Film/Film_Form'));
